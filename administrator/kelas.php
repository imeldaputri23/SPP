                          ...
                          <div class="modal-body">
                            <form action="update_kelas.php" method="post">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="kompetensi_keahlian" value="<?php echo $d_kelas['kompetensi_keahlian']; ?>" class="form-control" placeholder="Masukan Kompetensi Keakhlian">
                              </div>
                    ...
                    <div class="modal fade" id="modal-hapus<?php echo $d_kelas['id_kelas']; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>Apakah Anda Yakin Akan Menghapus Kelas <?php echo $d_kelas['nama_kelas']; ?> Kompetensi Keakhlian <?php echo $d_kelas['kompetensi_keahlian']; ?> ???</p>
                          </div>
                          <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="simpan_kelas.php" method="post">
                            ...
                            <div class="form-group">
                              <label>Kompetensi Keakhlian</label>
                              <input type="text" name="kompetensi_keahlian" class="form-control" placeholder="Masukan Kompetensi Keakhlian">
                            </div>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-default" data-dismiss="modal">Keluar</button>
                              <button type="submit" class="btn btn-primary">Simpan</button>
